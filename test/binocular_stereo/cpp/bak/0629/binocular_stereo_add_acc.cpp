...
float speed_right[30] = {18.596,16.133,13.829,11.6565,9.6585,7.9595,6.4225,5.0415,3.804,2.7315,1.8085,1.0325,0.4185};
						...
						switch(it->n){
							...
							case 1:
									...
									if(frontdis.size() >= 3)
									{
										...
										predict_second(frontdis, frontoutput, front_output_v, front_output_a, 0.8, 3, 3, 110);
							...
							case 2:
									...
									if(rightdis.size() >= 3)
									{
										...
										predict_second(rightdis, rightoutput, right_output_v, right_output_a, 0.8, 3, 3, 110);
